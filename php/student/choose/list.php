...
$db = pdo_init();
$sql = "select p.id,p.name,p.collage,htu_teacher.name as teacher from (select htu_subject.* from htu_subject inner join htu_score on htu_subject.id=htu_score.subject where htu_score.student=:id) as p inner join htu_teacher on p.teacher=htu_teacher.id";
$stat = $db->prepare($sql);
                        ...
                        <table class="table table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><button class="btn btn-default btn-xs infodelete" onClick="onClickDelete(<?php echo $value["id"]; ?>)">退选</button></td>
                                </tr>
