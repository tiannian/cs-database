        	...
        	<div class="col-xs-9">
                <form class="form-horizontal" role="form" method='post' action='checkadd.php'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="grade" type="text" class="form-control" id="inputGarde" placeholder="年级">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="sex" type="text" class="form-control" id="inputSex" placeholder="性别">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputGollage" class="col-sm-2 control-label">学院</label>
                        <div class="col-sm-10">
                            <input name="collage" type="text" class="form-control" id="inputGollage" placeholder="学院">
                        </div>
                    </div>
                    <div class="form-group">
