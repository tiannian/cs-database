        ...
        <div class="row">
        	...
        	<div class="col-xs-9">
                <form class="form-horizontal" role="form" method='post' action='checkupdate.php'>
                    ...
                    <div class="form-group">
                        <label for="inputGarde" class="col-sm-2 control-label">年级</label>
                        <div class="col-sm-10">
                            <input name="grade" type="text" class="form-control" id="inputGarde" value="<?php echo $row["grade"] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputMajor" class="col-sm-2 control-label">专业</label>
                        <div class="col-sm-10">
                            <input name="major" type="text" class="form-control" id="inputMajor" value="<?php echo $row["major"] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputSex" class="col-sm-2 control-label">性别</label>
                        <div class="col-sm-10">
                            <input name="sex" type="text" class="form-control" id="inputSex" value="<?php echo $row["sex"] ?>">
                        </div>
                    </div>
                    <div class="form-group">
